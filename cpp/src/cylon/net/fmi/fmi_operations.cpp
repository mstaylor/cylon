        ...
        Status FmiAllReduceImpl::AllReduceBuffer(const void *send_buf, void *rcv_buf, int count,
            ...
            switch (data_type->getType()) {
                ...
                case Type::UINT8:
                    ...
                    comm_ptr_->get()->allreduce(send_void_data, recv_void_data,
