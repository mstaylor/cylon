...
combination = [\
    ...
    ("dev-cylon-redis1.aws-cylondata.com", 16,8, 1, args['rows'], "standard", ""),
...
for redis, nodes, threads, cpus, rows, partition, exclusive in combination:
  ...
  lscpu
  echo "..............................................................."
  time srun --exact --nodes {nodes} python cylon_scaling.py -n {rows} -s {args["scaling"]}  -w {args["world_size"]} -r {redis} -p1 {args["redis_port"]}
  echo "..............................................................."
  """).strip()
